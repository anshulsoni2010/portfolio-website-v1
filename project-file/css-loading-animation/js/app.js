import {
    BUBBLE
} from './loaders/bubble.js';
import {
    CIRCLE
} from './loaders/circle.js';
import {
    RECT
} from './loaders/rect.js';
import {
    LINE
} from './loaders/line.js';
import {
    PROGRESS
} from './loaders/progress.js';
import {
    TEXT
} from './loaders/text.js';
import {
    GRAPH
} from './loaders/graph.js';
import {
    OBJECTS
} from './loaders/objects.js';
import {
    SKELETON
} from './loaders/skeleton.js';
...
function createLoader(i) {
    ...
    let shadowRoot = sectionEl.attachShadow({
        mode: 'open'
    });
